#!/usr/bin/env python3
"""
Create the dataset preprocessing script
"""
...
# Write the script
with open('preprocess_fod_dataset.py', 'w') as f:
    f.write(preprocessing_script)

print("Created preprocess_fod_dataset.py")
print("Run with: python preprocess_fod_dataset.py --dataset data/processed/fod_yolo")